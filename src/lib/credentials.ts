...
export const TRADE_RULES: Record<string, TradeRule> = {
  ...
  'food trucks': noLicence(
    ...
    + 'Each county issues its own permit, so the one you need is the county you '
    + 'actually work in. Get those before you take bookings.',
  ),
  'coffee and smoothie trucks': noLicence(
    ...
    + 'apply. Each county issues its own, so the permit you need is the one for '
    + 'the county you actually work in.',
  ),
